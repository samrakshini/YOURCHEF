        ...
        sendButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                cldata.addValueEventListener(new ValueEventListener() {
                    ...
                    Intent intent = new Intent(mexican.this, Dashboard_client.class);
                PendingIntent pending = PendingIntent.getActivity(mexican.this, 0, intent, 0);
                android.app.Notification noti = new android.app.Notification.Builder(mexican.this).setContentTitle("New Order from"+uid.toString()).setContentText(idate.getText().toString()).setSmallIcon(R.mipmap.ic_launcher).setContentIntent(pending).build();
